...
public class NavigationSystem : MonoBehaviour
{
    ...
    private const int ForgetEnemySeconds = 3;
    private const int MaximumSpiedEnemies = 1;
    #endregion

    private NavMeshAgent _navMeshAgent;
    public bool IsMovedToPoint { get; private set; }
    public bool IsEnemiesSpied => _spiedEnemies.Count > 0;
