...
public class EnemySpawner : MonoBehaviour
{
    ...
    [SerializeField]private PrefabsDictionary.Enemies enemyPrefab;
    [Space(15f)]
    ...
    public IEnumerator Spawn() 
    {
        ...
        for (int i = 0; i < enemyCount; i++)
        {
            ...
            var lookAt = Quaternion.LookRotation(Vector3.forward, pos + fireDirection);
            ...
            switch (behaviourType)
            {
                case Enemy.BehaviourType.D_type:
                    ...
                    enemy.moveParams_D.time = animationTime;
                ...
                case Enemy.BehaviourType.O_type:
                    ...
                    enemy.moveParams_O.time = cycleTime;
